      ...
      <div className="container py-5">
        ...
        <div className="row align-items-center g-5">
          <div className="col-lg-4 text-center">
            <div
              className="rounded-circle mx-auto d-flex align-items-center justify-content-center text-info fw-bold"
              style={{
                width: "220px",
                height: "220px",
          ...
          <div className="col-lg-8">
            ...
            <p className="text-secondary mb-3" style={{ lineHeight: "1.8" }}>
              Je suis un développeur web full stack avec une passion pour la création d'expériences
              numériques élégantes et performantes. J'aime transformer des idées complexes en
              interfaces simples et intuitives.
            </p>
            <p className="text-secondary mb-4" style={{ lineHeight: "1.8" }}>
              Toujours en veille technologique, j'aime explorer de nouveaux outils et frameworks
              pour livrer des solutions modernes et adaptées aux besoins des utilisateurs.
            </p>
